...
def calculate_text_similarities(text1: str, text2: str, nlp_model=None) -> dict:
    """
    Calculate multiple secondary similarity metrics between two text strings.
    WRatio and Levenshtein are assumed to be pre-calculated during candidate selection.
    """
    # Basic validation
    ...
    # AU removed match
    au_match = calculate_au_removed_match(text1, text2)

    return {
        "jaccard_similarity": jaccard_sim,
        "spacy_similarity": spacy_sim,
        "no_space_exact_match": no_space_match,
        "au_removed_match": au_match
    }
